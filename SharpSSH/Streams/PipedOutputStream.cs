	...
	public class PipedOutputStream : SharpSsh.java.io.OutputStream
	{
		...
		*/
		...
		public virtual void connect(PipedInputStream stream)
		{
			...
			else if (m_stream != null || stream.connected)
		...
		public override void flush()
		{
			if (m_stream != null)
				lock (m_stream)
				{
					System.Threading.Monitor.PulseAll(m_stream);
				}
		}
